...
public class RollerCoaster {
	...
	public static void main(String[] args) {
		...
		String heightToRide = JOptionPane.showInputDialog(null, "How tall are you");
		...
		int heint = Integer.parseInt(heightToRide);

		if (heint >= 48) {
			JOptionPane.showMessageDialog(null, "You can ride");
		} else if (heint >= 42) {
			JOptionPane.showMessageDialog(null, "You have to ride with an adult");
		} else {
			JOptionPane.showMessageDialog(null, "You have to be at least 42 inches pal");
		}
